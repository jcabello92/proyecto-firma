...
class SexoController extends Controller
{
    ...
    public function index(int $pagina)
    {
        ...
        $elementos = Sexo::select($campos)->where('activo', 1)->skip($pagina)->limit(50)->get();
    ...
    public function show(int $id)
    {
        ...
        $elemento = Sexo::select($campos)->where('id', $id)->where('activo', 1)->limit(1)->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:10|required|unique:App\Models\Sexo,nombre'
        ]);
    ...
    public function update(int $id, Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:10|unique:App\Models\Sexo,nombre',
