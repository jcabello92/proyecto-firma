...
class ComunaController extends Controller
{
    ...
    public function index(int $pagina)
    {
        ...
        $elementos = Comuna::select($campos)->where('activo', 1)->skip($pagina)->limit(50)->get();
    ...
    public function show(int $id)
    {
        ...
        $elemento = Comuna::select($campos)->where('id', $id)->where('activo', 1)->limit(1)->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:64|required|unique:App\Models\Comuna,nombre',
            'provincia' => 'integer|digits_between:1,2|required'
        ]);
    ...
    public function update(int $id, Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:64|unique:App\Models\Comuna,nombre',
            'provincia' => 'integer|digits_between:1,2',
        ...
        {
            $elemento->provincia = $request->provincia;
        }
