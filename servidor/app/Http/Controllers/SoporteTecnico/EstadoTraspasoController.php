...
use App\Models\SoporteTecnico\EstadoTraspaso;

class EstadoTraspasoController extends Controller
{
    ...
    public function index(int $pagina)
    {
        ...
        $elementos = EstadoTraspaso::select($campos)->where('activo', 1)->skip($pagina)->limit(50)->get();
    ...
    public function show(int $id)
    {
        ...
        $elemento = EstadoTraspaso::select($campos)->where('id', $id)->where('activo', 1)->limit(1)->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:10|required|unique:App\Models\EstadoTraspaso,nombre'
        ]);
        ...
        $elemento = EstadoTraspaso::insert([
    ...
    {
        $elemento = EstadoTraspaso::find($id);
        ...
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:10|unique:App\Models\EstadoTraspaso,nombre',
