...
use App\Models\SoporteTecnico\EstadoTicket;
...
class EstadoTicketController extends Controller
{
    ...
    public function index(int $pagina)
    {
        ...
        $elementos = EstadoTicket::select($campos)->where('activo', 1)->skip($pagina)->limit(50)->get();
    ...
    public function show(int $id)
    {
        ...
        $elemento = EstadoTicket::select($campos)->where('id', $id)->where('activo', 1)->limit(1)->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:20|required|unique:App\Models\EstadoTicket,nombre'
        ]);
    ...
    public function update(int $id, Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:20|unique:App\Models\EstadoTicket,nombre',
