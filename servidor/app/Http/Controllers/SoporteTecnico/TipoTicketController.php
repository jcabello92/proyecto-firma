...
use App\Models\SoporteTecnico\TipoTicket;
...
class TipoTicketController extends Controller
{
    ...
    public function index(int $pagina)
    {
        ...
        $elementos = TipoTicket::select($campos)->where('activo', 1)->skip($pagina)->limit(50)->get();
    ...
    public function show(int $id)
    {
        ...
        $elemento = TipoTicket::select($campos)->where('id', $id)->where('activo', 1)->limit(1)->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:12|required|unique:App\Models\TipoTicket,nombre'
        ]);
    ...
    public function update(int $id, Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:12|unique:App\Models\TipoTicket,nombre',
