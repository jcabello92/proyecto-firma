...
use App\Models\SoporteTecnico\Solicitud;
...
class SolicitudController extends Controller
{
    ...
    public function index(int $pagina)
    {
        ...
        $elementos = Solicitud::select($campos)->where('activo', 1)->skip($pagina)->limit(50)->get();
    ...
    public function show(int $id)
    {
        ...
        $elemento = Solicitud::select($campos)->where('id', $id)->where('activo', 1)->limit(1)->get();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:64|required|unique:App\Models\Solicitud,nombre',
            'tipo_solicitud' => 'integer|digits_between:1,2|required'
        ]);
    ...
    public function update(int $id, Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'nombre' => 'max:64|unique:App\Models\Solicitud,nombre',
            'tipo_solicitud' => 'integer|digits_between:1,2',
        ...
        {
            $elemento->tipo_solicitud = $request->tipo_solicitud;
        }
