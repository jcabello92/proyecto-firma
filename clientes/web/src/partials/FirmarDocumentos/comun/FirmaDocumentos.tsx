...
//importacion por mi
import PDFEditor from '../../../partials/FirmarDocumentos/comun/PDFViewer';

const pages = [{ name: "Firma de Documentos", href: "", current: true}];
...
export default function FirmaDocumentos({ theme }: props) {
